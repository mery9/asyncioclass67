...
async def FryEggs(eggs):
    print(f"{time.ctime()} - Begin fry egg...")
...
async def main():
    ...
    bacon_task = asyncio.create_task(FryBacon()) # schedule execution
    toast_task = asyncio.create_task(ToastBread(2)) # schedule execution
